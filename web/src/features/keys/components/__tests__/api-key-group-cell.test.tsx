...
describe('API key group table cell', () => {
  ...
  // AutoGroupBadge is temporarily disabled upstream (QuantumNous/new-api
  // PR #6590, e17c647), so only the ratio badge renders an Auto frame.
  ...
  test('renders no Auto visuals when ratio data is unavailable', async () => {
    const container = document.createElement('div')
    document.body.append(container)
    const root = createRoot(container)
