...
func UpdateUser(c *gin.Context) {
	...
	if updatedUser.MaxConcurrency != nil && (*updatedUser.MaxConcurrency < -1 || *updatedUser.MaxConcurrency > 10000) {
		common.ApiErrorMsg(c, "user max concurrency must be in [-1, 10000]")
		return
	}
